	...
	return (
		<>
			...
			<section className={styles.section}>
				...
				<p>
					Whether you have waste to dispose of or
					are looking for recyclable materials to support your business, we bring both worlds together in one seamless,
					eco-friendly solution. By fostering collaboration, we reduce landfill waste, lower environmental impact, and
					encourage responsible resource use.
				</p>
				<p>
					Our mission is simple: to promote environmental sustainability through
					innovation and cooperation. Together, we can minimize waste, protect natural ecosystems, and create a greener
					future for generations to come.
				</p>
				<p>
					Join us on this journey toward a cleaner world. Let’s turn waste into
